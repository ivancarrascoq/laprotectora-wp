...
?>
    ...
    <style type="text/css">
		...
		.ui-datepicker .ui-datepicker-next span { background-color: <?php echo $nd_cc_customizer_color_dark_1;  ?>; }
		...
		/*color_dark_2*/
		.nd_cc_bg_greydark_2, .ui-datepicker .ui-datepicker-header { background-color: <?php echo $nd_cc_customizer_color_dark_2;  ?>; }
		.nd_cc_bg_greydark_2_important { background-color: <?php echo $nd_cc_customizer_color_dark_2;  ?> !important; }
		
		/*color_1*/
		.nd_cc_bg_yellow, .nd_cc_btn_pagination_active, .ui-datepicker-today a { background-color: <?php echo $nd_cc_customizer_color_1;  ?>; }
...
?>
    ...
    <style type="text/css">
		...
		.ui-datepicker-group { background-color: <?php echo $nd_cc_customizer_color_dark_1;  ?>; }

		/*color_dark_2*/
		.ui-datepicker .ui-datepicker-header { background-color: <?php echo $nd_cc_customizer_color_dark_2;  ?>; }
		
		/*color_1*/
		.ui-datepicker-today a { background-color: <?php echo $nd_cc_customizer_color_1;  ?>; }
