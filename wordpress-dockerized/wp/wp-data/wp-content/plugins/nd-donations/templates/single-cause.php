	    		...
	    		<form method="post" action="'.nd_donations_get_thankyou_page().'">
	    			...
	    			<div class="nd_donations_section">
						<div class="nd_donations_display_table nd_donations_float_left">
						    ...
						    <h4 class="nd_donations_display_table_cell nd_donations_vertical_align_middle nd_options_color_greydark nd_donations_padding_0_responsive nd_donations_padding_left_20 nd_donations_margin_0 nd_donations_padding_top_0">'.__('INSERT YOUR AMOUNT','nd-donations').'</h4>
						</div>
					</div>
					<!--end title-->
				...
				<div id="nd_donations_tab_payment_selection" class="nd_donations_tabs nd_donations_section nd_donations_position_relative ">
					...
					<div class="nd_donations_section">
						...
						<ul class="nd_donations_list_style_none nd_donations_margin_0 nd_donations_padding_0 nd_donations_padding_0_responsive nd_donations_float_left nd_donations_padding_left_20">
							<li class="nd_donations_display_inline_block nd_donations_margin_right_40">
								<h4>
									<a class="nd_donations_outline_0 nd_donations_padding_10_0 nd_donations_padding_top_5 nd_donations_display_inline_block nd_options_first_font nd_options_color_greydark" href="#nd_donations_single_cause_tab_paypal">'.__('PAYPAL','nd-donations').'</a>
								</h4>
							</li>
							<li class="nd_donations_display_inline_block nd_donations_margin_right_40">
								<h4>
									<a class="nd_donations_outline_0 nd_donations_padding_10_0 nd_donations_padding_top_5 nd_donations_display_inline_block nd_options_first_font nd_options_color_greydark" href="#nd_donations_single_cause_tab_offline_donation">'.__('OFFLINE DONATION','nd-donations').'</a>
								</h4>
							</li>
						</ul>
